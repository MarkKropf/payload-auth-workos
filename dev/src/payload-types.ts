...
/**
 * OAuth account linkages for WorkOS authentication
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface AdminAccount {
  ...
  /**
   * OAuth provider name (e.g., workos, google, github)
   */
  provider: string;
  /**
  ...
  /**
   * OAuth access token (hidden for security)
   */
  accessToken?: string | null;
  /**
   * OAuth refresh token (hidden for security)
   */
